...
import img1 from '../imgs/one swiper imgs/bg-1.png'
import img2 from '../imgs/one swiper imgs/bg-2.png'
import img3 from '../imgs/one swiper imgs/bg-3.png'
...
const {t} = useTranslation();
  return (
    <>
      ...
      >
        <SwiperSlide className='relative flex h-[400px] md:h-full'>
